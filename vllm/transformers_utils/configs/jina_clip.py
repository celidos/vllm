...
class JinaCLIPTextConfig(PretrainedConfig):  # MEX: something to review
    ...
    def from_pretrained(    # ME: should I keep it?
        ...
        logging.warning('CALLED TEXT CONFIG FROM PRETRAINED')
        logging.warning(f'    pretrained_model_name_or_path={pretrained_model_name_or_path}')
        
        configdict, kwargs = cls.get_config_dict(
            pretrained_model_name_or_path, **kwargs
        )
        logging.warning(f'    config_dict after that is={configdict}')
        logging.warning(f'    kwargs after that is={kwargs}')
...
AutoConfig.register("jina_clip_text", JinaCLIPTextConfig)
AutoConfig.register("jina_clip_vision", JinaCLIPVisionConfig)
